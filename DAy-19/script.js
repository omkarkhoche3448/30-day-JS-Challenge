...
task8("This is a sample string ending with Letters");

// Test with the original string (which won't match)
task8("This is a sample string with words starting with capital Letters.");
